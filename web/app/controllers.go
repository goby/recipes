...
type OperandsController interface {
	...
	Minus(*MinusOperandsContext) error
}
...
func MountOperandsController(service *goa.Service, ctrl OperandsController) {
	...
	h = func(ctx context.Context, rw http.ResponseWriter, req *http.Request) error {
		...
		// Build the context
		rctx, err := NewMinusOperandsContext(ctx, req, service)
		if err != nil {
			return err
		}
		return ctrl.Minus(rctx)
	}
	service.Mux.Handle("GET", "/minus/:left/:right", ctrl.MuxHandler("minus", h, nil))
	service.LogInfo("mount", "ctrl", "Operands", "action", "Minus", "route", "GET /minus/:left/:right")
}
